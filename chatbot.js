...
class PortfolioChatbot {
  ...
  generateResponse(message) {
    ...
    if (lowerMessage.includes('skill') || lowerMessage.includes('programming') || lowerMessage.includes('language') || lowerMessage.includes('tech')) {
    ...
    // Education questions
    if (lowerMessage.includes('education') || lowerMessage.includes('school') || lowerMessage.includes('degree') || lowerMessage.includes('study')) {
    ...
    // Location questions
    if (lowerMessage.includes('location') || lowerMessage.includes('where') || lowerMessage.includes('live') || lowerMessage.includes('atlanta')) {
    ...
    if (lowerMessage.includes('strength') || lowerMessage.includes('quality') || lowerMessage.includes('good at')) {
    ...
    if (lowerMessage.includes('looking for') || lowerMessage.includes('goal') || lowerMessage.includes('want')) {
